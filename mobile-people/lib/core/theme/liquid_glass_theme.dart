...
class LiquidGlassTheme {
  ...
  static List<Color> auroraPalette(BuildContext context) {
    ...
    if (dark) {
      return const [
        ...
        Color(0xFF3B82F6), // Electric Sapphire
        Color(0xFF06B6D4), // Luminous Cyan
      ];
    } else {
      return const [
        Color(0xFFFBCFE8), // Soft Rose Petal
  ...
  /// Glowing jewel LED effect for countdown badges
  static BoxDecoration jewelCountdown({required int daysRemaining}) {
