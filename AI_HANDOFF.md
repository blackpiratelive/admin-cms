...
- **Google Reader API Authentication**: Connects using FreshRSS GReader API compatibility layer (`/api/greader.php`) supporting `ClientLogin` and Basic Auth fallbacks.
